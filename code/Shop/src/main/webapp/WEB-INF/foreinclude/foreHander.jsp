            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="header-top-text text-center text-lg-left mb-0 mb-md-15 mb-sm-15">
                        <p><i class="icon ion-md-alarm"></i> 价格公道童叟无欺  <span class="support-no">: (021) 114514</span></p>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-7">
                    ...
                    <div class="main-menu">
                        <nav>
                            <ul>
                                <li class="active menu-item-has-children"><a href="#">商品分类</a>
                                    <ul class="sub-menu">
                                ...
                                <li><a href="/fore/foreZixuns">资讯</a></li>
