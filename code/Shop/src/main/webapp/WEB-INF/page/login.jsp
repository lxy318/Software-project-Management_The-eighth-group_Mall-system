...
<head>
    ...
    <title>xanthine-mvc后台登陆</title>

    <style type="text/css">
        *{padding:0px;margin:0px;}
        body{font-family:Arial, Helvetica, sans-serif;background:url(../../images/grass.png);font-size:12px;}
        img{border:0;}
        .lg{width:468px;height:468px;margin:100px auto;background:url(../../images/lbg.png) no-repeat;}
